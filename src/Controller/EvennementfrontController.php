...
class EvennementfrontController extends AbstractController
{
    ...
    public function index(EvennementRepository $repository,ManagerRegistry $doctrine,Request $request): Response
    {
...
public function participer(Request $request,$id,ManagerRegistry $doctrine): Response
{
