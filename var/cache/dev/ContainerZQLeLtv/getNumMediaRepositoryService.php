 ...
 */
class getNumMediaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NumMediaRepository' shared autowired service.
     *
     * @return \App\Repository\NumMediaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NumMediaRepository.php';

        return $container->privates['App\\Repository\\NumMediaRepository'] = new \App\Repository\NumMediaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
