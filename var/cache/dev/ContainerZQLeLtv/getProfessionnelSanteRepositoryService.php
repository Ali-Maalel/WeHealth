 ...
 */
class getProfessionnelSanteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfessionnelSanteRepository' shared autowired service.
     *
     * @return \App\Repository\ProfessionnelSanteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfessionnelSanteRepository.php';

        return $container->privates['App\\Repository\\ProfessionnelSanteRepository'] = new \App\Repository\ProfessionnelSanteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
