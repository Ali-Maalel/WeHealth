...
class __TwigTemplate_c710d5810f5be437f0c1562b5bb32a92 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  109 => 40,  100 => 34,  88 => 25,  63 => 2,  44 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"{{ path('app_admin') }}\">Tableau de Bord
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"elements.html\">Element</a>
...
\t</header>
{% endblock %}
", "utils/header.html.twig", "C:\\Users\\yasmi\\Pidev WeHealth\\WeHealth\\templates\\utils\\header.html.twig");
    }
}
