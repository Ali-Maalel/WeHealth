...
class __TwigTemplate_a21e0525694530df72eec94bd1f648d3 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
      ...
      <div class=\"row\">
        ...
        echo "
                  ...
                  <div class=\"form-group\">
                    <label for=\"exampleSelect1\">Date de l'évenement</label>
                     ";
        // line 32
        ...
        echo "
                  ...
                  <div class=\"form-group\">
                    <label for=\"exampleSelect1\">lien lien evenement</label>
                     ";
        // line 37
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 37, $this->source); })()), "consultationurl", [], "any", false, false, false, 37), 'widget', ["attr" => ["class" => "form-control"]]);
        echo "
                    </select>
                  </div>
        ...
        // line 47
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 47, $this->source); })()), "ajouter")) : ("ajouter")), "html", null, true);
        echo "</button>
...
";
    ...
    {
        return array (  132 => 47,  123 => 41,  116 => 37,  108 => 32,  101 => 28,  94 => 24,  88 => 21,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{% endblock %}
", "evennement/_form.html.twig", "C:\\Users\\lenovo\\Desktop\\Cities.Skylines.v1.16.0.f3.Incl.ALL.DLC\\Nouveau dossier\\WeHealth\\templates\\evennement\\_form.html.twig");
    }
}
