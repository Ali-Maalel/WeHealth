...
\t\t\t\t\t\t\t\t\t<a href=\"";
        // line 55
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_myevennement_index");
        echo "\" class=\"btn header-btn\">Mes évenements</a>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div id=\"notification-icon\" style=\"font-size: 20px;margin-left:30px;\">
...
";
    ...
    {
        return array (  124 => 55,  100 => 34,  88 => 25,  63 => 2,  44 => 1,);
    }
...
\t\t\t\t\t\t\t\t<div> </div>
\t\t\t\t\t\t\t\t<div class=\"header-right-btn f-right d-none d-lg-block ml-15\">
\t\t\t\t\t\t\t\t\t<a href=\"{{ path('app_myevennement_index') }}\" class=\"btn header-btn\">Mes évenements</a>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div id=\"notification-icon\" style=\"font-size: 20px;margin-left:30px;\">
    <i class=\"fa fa-bell\"></i>
</div>
...
\t</header>
{% endblock %}
", "utils/header.html.twig", "C:\\Users\\sarra\\OneDrive\\Desktop\\myapp\\WeHealth\\templates\\utils\\header.html.twig");
    }
}
