...
class __TwigTemplate_0e02c8518c94f1dd4ed771b359cbfe69 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<span id=\"comment-count\">";
        // line 17
        echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 17, $this->source); })()), "comments", [], "any", false, false, false, 17)), "html", null, true);
        echo "</span>
\t\t\tcommentaire(s)</h2>
...
\t";
    ...
    {
        return array (  109 => 17,  103 => 14,  95 => 9,  92 => 8,  82 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
