...
class __TwigTemplate_93ec8b3ab85e95b8c08868c6dc63f3f7 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo " <form action=\"";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("process_payment", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["event"]) || array_key_exists("event", $context) ? $context["event"] : (function () { throw new RuntimeError('Variable "event" does not exist.', 6, $this->source); })()), "id", [], "any", false, false, false, 6)]), "html", null, true);
        echo "\" method=\"POST\">
...
{% block body %}
 <form action=\"{{ path('process_payment', {'id': event.id}) }}\" method=\"POST\">
        <label for=\"card_number\">Numéro de carte</label>
        <input type=\"text\" id=\"card_number\" name=\"card_number\">
...
{% endblock %}
", "stripe/index.html.twig", "C:\\Users\\sarra\\OneDrive\\Desktop\\myapp\\WeHealth\\templates\\stripe\\index.html.twig");
    }
}
