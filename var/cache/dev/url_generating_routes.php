...
return [
    ...
    'app_topic_edit' => [['id'], ['_controller' => 'App\\Controller\\TopicController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/topic']], [], [], []],
    'app_topic_delete' => [['id'], ['_controller' => 'App\\Controller\\TopicController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/topic']], [], [], []],
