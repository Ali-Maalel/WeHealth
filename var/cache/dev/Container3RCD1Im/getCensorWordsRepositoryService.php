 ...
 */
class getCensorWordsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CensorWordsRepository' shared autowired service.
     *
     * @return \App\Repository\CensorWordsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CensorWordsRepository.php';

        return $container->privates['App\\Repository\\CensorWordsRepository'] = new \App\Repository\CensorWordsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
