 ...
 */
final class Version20230221220214 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patient (id INT AUTO_INCREMENT NOT NULL, iduser INT NOT NULL, login VARCHAR(30) NOT NULL, password VARCHAR(32) NOT NULL, nom VARCHAR(30) NOT NULL, prenom VARCHAR(30) NOT NULL, email VARCHAR(100) NOT NULL, telephone VARCHAR(15) DEFAULT NULL, typeuser VARCHAR(50) NOT NULL, maladie VARCHAR(80) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
